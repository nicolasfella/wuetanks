...
public class Bullet extends Entity {
	...
	public Bullet(Player player, Vector2 position) {
		...
		width = Wuetanks.getInstance().getPreferences().getInteger("bullet_width", 12);
		height = Wuetanks.getInstance().getPreferences().getInteger("bullet_height", 26);
		movingSpeed = Wuetanks.getInstance().getPreferences().getInteger("bullet_speed", 450);
